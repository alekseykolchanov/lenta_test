...
- (NSManagedObjectContext *)masterManagedObjectContext {
    ...
    if (coordinator != nil) {
        ...
        [_masterManagedObjectContext performBlockAndWait:^{
            ...
            [[_masterManagedObjectContext undoManager]disableUndoRegistration];
        }];
...
- (NSManagedObjectContext *)backgroundManagedObjectContext {
    ...
    if (masterContext != nil) {
        ...
        [_backgroundManagedObjectContext performBlockAndWait:^{
            ...
            [[_backgroundManagedObjectContext undoManager]disableUndoRegistration];
        }];
    }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"controlmanager" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"lentatest.sqlite"];
